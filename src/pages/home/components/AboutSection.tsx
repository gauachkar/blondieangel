const TAGS = ["18 & Unbothered", "Anime Expert", "Findom Brat", "Feet Content", "Gamer RP", "Custom Sessions", "JRPG Addict", "Arizona LLC"];
const GAMES = ["🗡️ Final Fantasy XIV", "🔫 Destiny 2", "⚔️ Elden Ring", "🌸 Persona Series", "🎮 Dead by Daylight", "🧙 World of Warcraft"];

export default function AboutSection() {
  return (
    <section id="about" className="relative w-full bg-[#080808] py-24 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="relative gradient-border-card rounded-3xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-[#8B00FF]/30 to-[#FF1493]/20 p-4 border-b border-[#8B00FF]/20 flex items-center gap-3">
                  ...
                  <span className="font-orbitron text-xs text-[#00FFFF]/70 tracking-widest">LILA_VIBES.EXE</span>
          ...
          <div>
            ...
            <h2 className="font-orbitron font-black text-3xl md:text-4xl lg:text-5xl text-white leading-tight mb-8 glitch-text">
              18. Dominant.{" "}
              <span className="shimmer-text">Running a Business.</span>{" "}
              Deal With It.
            </h2>

            <div className="space-y-5 text-white/65 text-base leading-relaxed font-inter">
              <p>
                Yeah, I'm <strong className="text-[#00FFFF] font-semibold">18</strong>. And I already run my own LLC, provide for my loved ones, and do exactly what I love every single day. Gaming, anime, dominance, and draining wallets — this is my full-time passion and my real business. Jealous?
              </p>
              <p>
              ...
              <p>
                Registered LLC in Arizona. I pay my taxes. My body, my rules, my <em className="text-[#8B00FF] not-italic">business</em>. If you're here, you already know what you want — so stop hesitating and <strong className="text-white font-semibold">book a session already.</strong>
              </p>
            </div>
